...
//    emscripten_set_timeout(timer_callback, 50, NULL);
...
//    emscripten_set_keydown_callback("#canvas", NULL, false, key_callback);
    ...
    //emscripten_set_keydown_callback(0, NULL, true, key_callback);
